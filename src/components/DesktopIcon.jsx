...
export default function DesktopIcon({ icon, iconName, modalContent }) {
    ...
    // Hook to handle "clicking other things"
    ...
    const handleClick = () => {
        if (timerRef.current) {
            ...
            setIsModalOpen(true); // Double click: Open Modal
        } else {
            setIsHighlighted(true); // Single click: Highlight instantly
            ...
            <div ref={containerRef} className="desktop_icon_wrapper">
                ...
                <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
                    <div className='title_bar'>
                        ...
                        <div>
                            <div className='title_bar_button' onClick={() => setIsModalOpen(false)}><i className="hn hn-times-solid"></i></div>
                        </div>
                    </div>
